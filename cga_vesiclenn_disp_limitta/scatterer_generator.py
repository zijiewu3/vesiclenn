...
class scatterer_generator:
    ...
    *TODO*
    '''
    def __init__(self,shape_params = [NNMODEL_DIR_PATH+'/1.h5',0.6],
                 minvalu = (150, 65,  0.2,1.0, 0.1, 1),#Rtotal tb/ta rhoAin/rhoAout pd bg
                 maxvalu = (3000,85, 3.0,2.0, 1.0, 5)):
